...
// Server provides an HTTP-wrapped interface to the gRPC API of the order service
...
func (s *HttpWrappedGrpcServer) Run() error {
	log.Printf("[order-api grpc-web (HTTP)] starting on %v", serviceregistry.OrderServiceGrpcwebPort)
